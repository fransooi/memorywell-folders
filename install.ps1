...
Copy-Item "$SCRIPT_DIR\src\init.js" "$INSTALL_DIR\src\"
Copy-Item "$SCRIPT_DIR\src\push.js" "$INSTALL_DIR\src\"
Copy-Item "$SCRIPT_DIR\src\pop.js" "$INSTALL_DIR\src\"
Copy-Item "$SCRIPT_DIR\src\extract.js" "$INSTALL_DIR\src\"
Copy-Item "$SCRIPT_DIR\src\import.js" "$INSTALL_DIR\src\"
Copy-Item "$SCRIPT_DIR\src\find.js" "$INSTALL_DIR\src\"
Copy-Item "$SCRIPT_DIR\src\setfavorite.js" "$INSTALL_DIR\src\"
Copy-Item "$SCRIPT_DIR\src\remap.js" "$INSTALL_DIR\src\"
...
Copy-Item "$SCRIPT_DIR\src\gui\gui-extract.js" "$INSTALL_DIR\gui\"
...
@"
@echo off
node "%USERPROFILE%\.memorywell\src\init.js" %*
"@ | Out-File -FilePath "$BIN_DIR\mwinit.bat" -Encoding ASCII

@"
@echo off
node "%USERPROFILE%\.memorywell\src\push.js" %*
"@ | Out-File -FilePath "$BIN_DIR\mwpush.bat" -Encoding ASCII

@"
@echo off
node "%USERPROFILE%\.memorywell\src\pop.js" %*
"@ | Out-File -FilePath "$BIN_DIR\mwpop.bat" -Encoding ASCII

@"
@echo off
node "%USERPROFILE%\.memorywell\src\extract.js" %*
"@ | Out-File -FilePath "$BIN_DIR\mwextract.bat" -Encoding ASCII

@"
@echo off
node "%USERPROFILE%\.memorywell\src\import.js" %*
"@ | Out-File -FilePath "$BIN_DIR\mwimport.bat" -Encoding ASCII

@"
@echo off
node "%USERPROFILE%\.memorywell\src\find.js" %*
"@ | Out-File -FilePath "$BIN_DIR\mwfind.bat" -Encoding ASCII

@"
@echo off
node "%USERPROFILE%\.memorywell\src\setfavorite.js" %*
"@ | Out-File -FilePath "$BIN_DIR\mwsetfavorite.bat" -Encoding ASCII

@"
@echo off
node "%USERPROFILE%\.memorywell\src\remap.js" %*
...
Write-Host "  mwpop          - Restore and remove from stack"
Write-Host "  mwextract      - Extract without removing"
Write-Host "  mwimport       - Import external directories"
Write-Host "  mwfind         - Search through archives"
Write-Host "  mwsetfavorite  - Mark/unmark archives as favorite"
Write-Host "  mwremap        - Remap symlinks"
Write-Host ""
